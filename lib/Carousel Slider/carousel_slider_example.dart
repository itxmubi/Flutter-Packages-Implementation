...
class _CarouselSliderExampleState extends State<CarouselSliderExample> {
  List<Widget> images = [
    Image.asset("assets/png/cs1.png"),
    Image.asset("assets/png/cs2.png"),
    Image.asset("assets/png/cs3.png"),
    Image.asset("assets/png/cs4.png"),
    Image.asset("assets/png/cs5.jpeg"),
  ];
