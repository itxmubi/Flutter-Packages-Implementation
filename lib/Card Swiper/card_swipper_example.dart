...
import 'package:flutter_packages_implementation/Card%20Swiper/src/example_swipper_scrollview.dart';
...
class CardSwipperExample extends StatelessWidget {
  const CardSwipperExample({Key? key}) : super(key: key);
        ...
        children: <Widget>[
          ...
          Swiper.children(
            ...
            children: <Widget>[
              ...
              Image.asset('assets/gallery3.jpg', fit: BoxFit.contain)
            ],
          )
        ],
      ),
